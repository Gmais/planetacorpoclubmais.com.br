...
if ( have_posts() ) {
	...
	if ( is_search() ) { ?>
		<article class="btNoSearchResults">
			<?php echo boldthemes_get_heading_html( esc_html__( 'We are sorry, no results for: ', 'fitness-club' ) . get_search_query(), '', "<a href='" . site_url() . "'>" . esc_html__( 'Back to homepage', 'fitness-club' )."</a>", 'extralarge', 'bottom', '', '' ) ?>
		</article>
	<?php }
}
